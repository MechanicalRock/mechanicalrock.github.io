...
Redirect is a Rust project that implements an AWS Lambda function to redirect blog posts to the new directory.
...
To build the project for production, run `make build`.
