...
function setGallery(el) {
	...
	if(el.closest('ul, p')) {
		var link_elements = el.closest('ul, p').querySelectorAll("[class*='lightbox-']");
		link_elements.forEach(link_element => {
			link_element.classList.remove('current');
		});
		link_elements.forEach(link_element => {
			if(el.getAttribute('href') == link_element.getAttribute('href') || el.getAttribute('src') == link_element.getAttribute('src')) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var elementsToLightbox = document.querySelectorAll('[lightbox]');
    elementsToLightbox.forEach(element => {
