...
Experience is another means by which we reduce potential exposure to technical debt through specialisation. A team is more effective at building a system if it includes members that have built such a system before, and/or have experience with the domain. As a society we have recognised this fact with increased responsiblity and compensation for accomplished individuals. There is still an element of risk and debt involved. A return-on-investment is expected. The company pays more in upfront labour costs for the accomplished individual and expects that the chance of success has increased.
