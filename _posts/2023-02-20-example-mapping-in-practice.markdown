...
![Story and rules defined](/img/blog/examplemapping/initialrules.png)

The team get about asking questions around the discounts and limit:
![Questions added to rules](/img/blog/examplemapping/questions.png)

The questions lead to examples being specified, and a new rule emerges which needs examples to help explain:

![Stories, Rules and Examples](/img/blog/examplemapping/examplemap.png)
...
![Table showing the dollar values of spends and savings per month](/img/blog/examplemapping/humbletable.png)
...
<br/>
Applying the same principle for our 'Kwik-E-Mart' app membership options might look like this.
...
![Example map with one rule and a couple of examples](/img/blog/examplemapping/timesaver.png)
